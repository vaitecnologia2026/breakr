...
export class DashboardMarketingService {
  ...
  async painel(filtros: { squadId?: string; clienteId?: string }) {
    ...
    // Esforço/dias previstos das PEÇAS DE CONTEÚDO pelo tipo de tarefa de cada uma
    // (Conteudo.tipoTarefaId -> TipoTarefa). Respeita os filtros de squad/cliente.
  ...
  // conteúdo pelo seu tipo de tarefa. Somente leitura; não altera nada.
