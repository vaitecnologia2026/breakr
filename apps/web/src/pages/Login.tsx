...
/**
 * Tela de login do Breakr OS — vitrine da identidade da marca.
 * Fundo preto fumaça com glow em gradiente brasa, card central,
 * formulário e-mail/senha e botão de ação em gradiente.
 */
export function Login() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      // Mensagens amigáveis a partir do erro da API.
